...
하루 동안 지갑에서 나간 금액이 평소보다 많이 쌓였다는 건, 사용자가 활발하게 거래하고 있다는 뜻일 수도 있지만 누군가 지갑을 털고 있다는 신호일 수도 있습니다. 특히 승인은 나중에 자금을 빼갈 권한을 새로 여는 행위라, 이미 당일 활동이 한도를 넘긴 상황에서 또 승인이 나오면 한 번 멈춰 확인하도록 경고합니다.
...
@severity("warn")
@reason("오늘 지갑에서 빠져나간 금액이 이미 $10,000을 넘었습니다. 이 승인이 맞는지 확인하세요.")
